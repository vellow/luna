...
class SessionManager(object):
    ...
    def _get_hmac_digest(self, session_id):
        return hmac.new(session_id.encode('utf-8'), self.secret.encode('utf-8'), hashlib.sha1).hexdigest()

    def _generate_uid(self):
        base = hashlib.md5( self.secret.encode('utf-8') + str(uuid.uuid4()).encode('utf-8') )
